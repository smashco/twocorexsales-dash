...
export const leads: Lead[] = [
  ...
  {
    id: "LOG-11",
    companyName: "Porter Logistics",
    city: "Mumbai",
    industry: "Logistics" as Lead["industry"],
    website: "https://www.porter.in",
    employees: "25-50",
    serviceFit: "Custom App" as Lead["serviceFit"],
    qualification: "WARM" as "HOT" | "WARM",
    confidencePct: 67,
    score: 7,
    category: "NURTURE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "truck and tempo dispatching coordinated entirely via WhatsApp and calls",
    painPoint2: "driver GPS tracking not integrated into any customer-facing status system",
    painPoint3: "billing and trip reconciliation done manually at end of day",
    intentLevel: "MEDIUM" as "HIGH" | "MEDIUM",
  ...
  {
    id: "FIN-3",
    companyName: "Tata AIG Insurance",
    city: "Mumbai",
    industry: "Financial Services" as Lead["industry"],
    ...
    score: 8,
    category: "HIGH VALUE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "policy renewal reminders managed manually by agents without a CRM system",
    painPoint2: "claim follow-up tracking done through email threads with no central visibility",
    painPoint3: "cross-sell of health and motor insurance to existing customers not systematically tracked",
    intentLevel: "HIGH" as "HIGH" | "MEDIUM",
