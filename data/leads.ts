...
export const leads: Lead[] = [
  ...
  {
    id: "FIN-15",
    companyName: "BC Shetty & Co",
    city: "Bangalore",
    industry: "Financial Services" as Lead["industry"],
    website: "https://bcshettyco.com",
    employees: "10-25",
    serviceFit: "Basic CRM" as Lead["serviceFit"],
    qualification: "WARM" as "HOT" | "WARM",
    confidencePct: 65,
    score: 7,
    category: "NURTURE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "client engagement and billing tracked in individual Excel files per partner",
    painPoint2: "no system to manage compliance deadlines and reminders for multiple clients",
    painPoint3: "foreign subsidiary and FEMA clients require document tracking that Excel cannot handle",
    intentLevel: "MEDIUM" as "HIGH" | "MEDIUM",
  ...
  {
    id: "FIN-23",
    companyName: "MoneyBoxx Finance",
    city: "Mumbai",
    industry: "Financial Services" as Lead["industry"],
    website: "https://moneyboxxfinance.com",
    employees: "25-50",
    serviceFit: "CRM + Portal" as Lead["serviceFit"],
    qualification: "HOT" as "HOT" | "WARM",
    confidencePct: 76,
    score: 8,
    category: "HIGH VALUE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "micro-entrepreneur loan applicant onboarding managed without a structured CRM",
    painPoint2: "field agent tracking and loan pipeline visibility lacks a centralized system",
    painPoint3: "collection follow-ups and customer communication managed through disconnected tools",
    intentLevel: "HIGH" as "HIGH" | "MEDIUM",
  ...
  {
    id: "HOS-9",
    companyName: "Bawa Group of Hotels",
    city: "Mumbai",
    industry: "Hospitality" as Lead["industry"],
    website: "https://bawahotels.com",
    employees: "25-50",
    serviceFit: "CRM + Portal" as Lead["serviceFit"],
    qualification: "HOT" as "HOT" | "WARM",
    confidencePct: 75,
    score: 8,
    category: "HIGH VALUE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "corporate booking and event inquiry management handled without a CRM",
    painPoint2: "group booking coordination across multiple hotel properties done manually",
    painPoint3: "repeat corporate client relationship management tracked in spreadsheets",
    intentLevel: "HIGH" as "HIGH" | "MEDIUM",
  ...
  {
    id: "TRV-5",
    companyName: "Gilpin Travel Management",
    city: "Mumbai",
    industry: "Travel & Tourism" as Lead["industry"],
    website: "https://gilpintravel.com",
    employees: "25-50",
    serviceFit: "CRM + Portal" as Lead["serviceFit"],
    qualification: "HOT" as "HOT" | "WARM",
    confidencePct: 74,
    score: 8,
    category: "HIGH VALUE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "corporate client travel bookings tracked across air, hotel, and visa in separate sheets",
    painPoint2: "no centralized CRM to manage repeat corporate accounts and travel policy compliance",
    painPoint3: "MICE and group travel coordination handled via email chains with no visibility",
    intentLevel: "HIGH" as "HIGH" | "MEDIUM",
