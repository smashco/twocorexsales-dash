...
export const LEADS: Lead[] = [
  {
    id: "RE-REP1",
    companyName: "Riddhi Siddhi Properties",
    city: "Worli, Mumbai",
  ...
  {
    id: "RE-REP2",
    companyName: "Mahavir Realty",
    city: "Goregaon East, Mumbai",
    industry: "Real Estate" as Lead["industry"],
    website: "www.mahavirrealty.co.in",
    employees: "5–10",
    serviceFit: "CRM",
    qualification: "HOT",
    confidencePct: 82,
  ...
  {
    id: "RE-REP3",
    companyName: "Shree Ganesh Builders",
    city: "Goregaon West, Mumbai",
    industry: "Real Estate" as Lead["industry"],
    website: "www.shreeganeshbuilders.co.in",
    employees: "3–8",
  ...
  {
    id: "RE-REP5",
    companyName: "Rajesh Realtors",
    city: "Santacruz East, Mumbai",
    industry: "Real Estate" as Lead["industry"],
    website: "",
    employees: "3–8",
    serviceFit: "CRM",
  ...
  {
    id: "RE-REP7",
    companyName: "Laxmi Property Consultants",
    city: "Magarpatta, Pune",
    industry: "Real Estate" as Lead["industry"],
    website: "",
    employees: "3–10",
    serviceFit: "CRM + Web Platform",
  ...
  {
    id: "RE-REP10",
    companyName: "Abhishek Infra Projects",
  ...
  {
    id: "RE-REP11",
    companyName: "Shubham Real Estate",
  ...
  {
    id: "RE-REP12",
    companyName: "Balaji Constructions",
    city: "Goregaon West, Mumbai",
    industry: "Real Estate" as Lead["industry"],
    website: "",
    employees: "3–10",
  ...
  {
    id: "RE-REP13",
    companyName: "Priya Housing Solutions",
    city: "Santacruz West, Mumbai",
    industry: "Real Estate" as Lead["industry"],
    website: "www.priyahousingsolution.in",
    employees: "3–8",
    serviceFit: "CRM + Web Platform",
    qualification: "WARM",
    confidencePct: 76,
  ...
  {
    id: "RE-REP14",
    companyName: "Sai Darshan Properties",
    city: "Kurla West, Mumbai",
    industry: "Real Estate" as Lead["industry"],
    website: "",
    employees: "5–15",
  ...
  {
    id: "RE-REP15",
    companyName: "Milestone Realtors",
    city: "Pimpri, Pune",
    industry: "Real Estate" as Lead["industry"],
    website: "",
    employees: "5–15",
  ...
  {
    id: "RE-REP17",
    companyName: "Patel Brothers Developers",
    city: "Chinchwad, Pune",
    industry: "Real Estate" as Lead["industry"],
    website: "",
    employees: "3–8",
  ...
  {
    id: "RE-REP18",
    companyName: "Aakar Infrastructure",
    city: "Hinjewadi, Pune",
    industry: "Real Estate" as Lead["industry"],
    website: "",
    employees: "3–10",
  ...
  {
    id: "RE-REP19",
    companyName: "Vastuvidya Properties",
  ...
  {
    id: "RE-REP20",
    companyName: "Trimurti Buildtech",
  ...
  {
    id: "FIT-REP13",
    companyName: "Rajesh Personal Training Centre",
  ...
  {
    id: "FIT-REP14",
    companyName: "Nirvana Spa & Fitness",
    city: "Hadapsar, Pune",
    industry: "Real Estate" as Lead["industry"],
    website: "",
    employees: "3–8",
  ...
  {
    id: "FIT-REP15",
    companyName: "Active Life Sports Club",
    city: "Thane West, Thane",
    industry: "Real Estate" as Lead["industry"],
    website: "",
    employees: "3–8",
  ...
  {
    id: "HC-REP1",
    companyName: "Sanjivani Multispecialty Clinic",
    city: "Malad West, Mumbai",
  ...
  {
    id: "HC-REP2",
    companyName: "Dr Mehta's Family Healthcare",
    city: "Kurla West, Mumbai",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "10–20",
  ...
  {
    id: "HC-REP3",
    companyName: "Arogya Wellness Centre",
    city: "Thane East, Thane",
    industry: "Healthcare" as Lead["industry"],
    website: "www.arogyawellnesscentre.co.in",
    employees: "5–12",
  ...
  {
    id: "HC-REP4",
    companyName: "Lifeline Diagnostics",
    city: "Hinjewadi, Pune",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "3–8",
  ...
  {
    id: "HC-REP5",
    companyName: "Sahyadri Health Solutions",
    city: "Kandivali West, Mumbai",
    industry: "Healthcare" as Lead["industry"],
    website: "www.sahyadrihealthsoluti.co.in",
    employees: "3–8",
    serviceFit: "CRM + App",
    qualification: "WARM",
    confidencePct: 84,
  ...
  {
    id: "HC-REP6",
    companyName: "Sunita Nursing Home",
    city: "Santacruz East, Mumbai",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "4–10",
  ...
  {
    id: "HC-REP7",
    companyName: "Prashant Dental & Orthodontics",
    city: "Chinchwad, Pune",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "3–6",
  ...
  {
    id: "HC-REP8",
    companyName: "Nirmala Eye Hospital",
    city: "Santacruz West, Mumbai",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "5–12",
  ...
  {
    id: "HC-REP9",
    companyName: "Vedanta Physiotherapy",
    city: "Lower Parel, Mumbai",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "2–6",
  ...
  {
    id: "HC-REP10",
    companyName: "Niramay Ayurvedic Clinic",
    city: "Worli, Mumbai",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "5–10",
  ...
  {
    id: "HC-REP11",
    companyName: "Swasthya Lab Services",
  ...
  {
    id: "HC-REP12",
    companyName: "Mediplus Pharmacy & Diagnostics",
    city: "Santacruz East, Mumbai",
    industry: "Healthcare" as Lead["industry"],
    website: "www.medipluspharmacydiag.co.in",
    employees: "4–8",
    serviceFit: "CRM + Appointment App",
    qualification: "WARM",
    confidencePct: 76,
  ...
  {
    id: "HC-REP13",
    companyName: "Anand Surgical Centre",
    city: "Borivali West, Mumbai",
    industry: "Healthcare" as Lead["industry"],
    website: "www.anandsurgicalcentre.in",
    employees: "3–8",
    serviceFit: "CRM + App",
    qualification: "WARM",
    confidencePct: 83,
  ...
  {
    id: "HC-REP14",
    companyName: "Cure & Care Polyclinic",
  ...
  {
    id: "HC-REP15",
    companyName: "Nakshatra Homeopathy",
  ...
  {
    id: "HC-REP16",
    companyName: "Pankaj Orthopaedic Clinic",
    city: "Warje, Pune",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "4–8",
  ...
  {
    id: "HC-REP17",
    companyName: "Shree Dhanvantari Hospital",
  ...
  {
    id: "HC-REP18",
    companyName: "Krishna Maternity Home",
    city: "Balewadi, Pune",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "5–12",
  ...
  {
    id: "HC-REP19",
    companyName: "Ashwini Healthcare",
    city: "Chembur, Mumbai",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "3–8",
  ...
  {
    id: "HC-REP20",
    companyName: "Asha Child Care Centre",
  ...
  {
    id: "FNB-REP12",
    companyName: "Rajwada Thali Restaurant",
    city: "Pimpri, Pune",
    industry: "Healthcare" as Lead["industry"],
    website: "",
    employees: "5–12",
  ...
  },
  {
    ...
    website: "www.spicerouterestaurant.in",
    employees: "10–25",
  ...
  {
    id: "FNB-REP2",
    companyName: "Amritsari Dhaba Mumbai",
    city: "Kandivali West, Mumbai",
    industry: "Food & Beverage" as Lead["industry"],
    website: "",
    employees: "5–20",
  ...
  {
    id: "FNB-REP4",
    companyName: "Pav Bhaji House",
    city: "Wakad, Pune",
    industry: "Food & Beverage" as Lead["industry"],
    website: "www.pavbhajihouse.co.in",
    employees: "2–8",
    serviceFit: "CRM + Subscription App",
    qualification: "WARM",
    confidencePct: 84,
  ...
  {
    id: "FNB-REP5",
    companyName: "Punjabi Tadka Kitchen",
    city: "Aundh, Pune",
    industry: "Food & Beverage" as Lead["industry"],
    website: "",
    employees: "8–15",
  ...
  {
    id: "FNB-REP6",
    companyName: "Shree Sai Catering Services",
    city: "Pimpri, Pune",
    industry: "Food & Beverage" as Lead["industry"],
    website: "www.shreesaicateringserv.in",
    employees: "5–12",
    serviceFit: "CRM + Loyalty App",
    qualification: "WARM",
    confidencePct: 74,
  ...
  {
    id: "FNB-REP7",
    companyName: "Green Leaf Veg Restaurant",
    city: "Magarpatta, Pune",
    industry: "Food & Beverage" as Lead["industry"],
    website: "",
    employees: "3–8",
  ...
  {
    id: "FNB-REP8",
    companyName: "Mithaas Sweet Shop",
    city: "Kharadi, Pune",
    industry: "Food & Beverage" as Lead["industry"],
    website: "",
    employees: "5–12",
  ...
  {
    id: "FIT-REP1",
    companyName: "IronZone Gym & Fitness",
    city: "Katraj, Pune",
  ...
  {
    id: "FIT-REP2",
    companyName: "Flex Studio Yoga & Pilates",
    city: "Thane West, Thane",
    industry: "Fitness" as Lead["industry"],
    website: "www.flexstudioyogapilate.com",
    employees: "5–20",
    serviceFit: "SaaS + App",
    qualification: "HOT",
    confidencePct: 83,
  ...
  {
    id: "FIT-REP3",
    companyName: "Mahavir Fitness Centre",
    city: "Borivali West, Mumbai",
    industry: "Fitness" as Lead["industry"],
    website: "www.mahavirfitnesscentre.in",
    employees: "3–8",
    serviceFit: "CRM + Member App",
    qualification: "HOT",
    confidencePct: 83,
  ...
  {
    id: "FIT-REP4",
    companyName: "PulseUp Health Club",
    city: "Lower Parel, Mumbai",
    industry: "Fitness" as Lead["industry"],
    website: "",
    employees: "3–8",
  ...
  {
    id: "FIT-REP5",
    companyName: "Ananya Zumba Academy",
    city: "Vashi, Navi Mumbai",
    industry: "Fitness" as Lead["industry"],
    website: "",
    employees: "3–8",
  ...
  {
    id: "FIT-REP6",
    companyName: "Strength Factory Gym",
  ...
  {
    id: "FIT-REP7",
    companyName: "Aura Wellness Studio",
    city: "Chembur, Mumbai",
    industry: "Fitness" as Lead["industry"],
    website: "",
    employees: "2–8",
  ...
  {
    id: "FS-REP1",
    companyName: "Laxmi Fin Corp",
    city: "Bandra West, Mumbai",
    industry: "Financial Services" as Lead["industry"],
    website: "www.laxmifincorp.com",
    employees: "10–25",
  ...
  {
    id: "FS-REP2",
    companyName: "Trustline Investment Advisors",
    city: "Sadashiv Peth, Pune",
    industry: "Financial Services" as Lead["industry"],
    website: "www.trustlineinvestmenta.in",
    employees: "5–20",
  ...
  {
    id: "FS-REP3",
    companyName: "Shreyas Insurance Brokers",
    city: "Santacruz West, Mumbai",
    industry: "Financial Services" as Lead["industry"],
    website: "",
    employees: "2–6",
  ...
  {
    id: "FS-REP4",
    companyName: "Prosperity Wealth Management",
    city: "Chembur, Mumbai",
    industry: "Financial Services" as Lead["industry"],
    website: "",
    employees: "1–5",
  ...
  {
    id: "FS-REP5",
    companyName: "Mahesh Finance & Loans",
    city: "Kharadi, Pune",
    industry: "Financial Services" as Lead["industry"],
    website: "",
    employees: "2–5",
  ...
  {
    id: "FS-REP6",
    companyName: "Angel Credit Solutions",
    city: "Lower Parel, Mumbai",
    industry: "Financial Services" as Lead["industry"],
    website: "",
    employees: "3–8",
  ...
  {
    id: "EVT-REP1",
    companyName: "Shagun Events & Weddings",
    city: "Malad East, Mumbai",
    industry: "Events" as Lead["industry"],
    website: "www.shaguneventsweddings.in",
    employees: "10–25",
  ...
  {
    id: "EVT-REP2",
    companyName: "Majestic Event Planners",
    city: "Deccan Gymkhana, Pune",
    industry: "Events" as Lead["industry"],
    website: "",
    employees: "3–8",
  ...
  {
    id: "EVT-REP3",
    companyName: "Dreamweave Wedding Co",
  ...
  {
    id: "RET-REP1",
    companyName: "Riddhi Fashion Boutique",
    city: "Goregaon East, Mumbai",
  ...
  {
    id: "RET-REP2",
    companyName: "Ganesh Electronics & Mobiles",
    city: "Kothrud, Pune",
    industry: "Retail" as Lead["industry"],
    website: "",
    employees: "10–25",
  ...
  },
  {
    ...
    city: "Hinjewadi, Pune",
    industry: "Retail" as Lead["industry"],
    website: "www.sunrisesupermarket.in",
    employees: "3–8",
    serviceFit: "CRM + Loyalty App",
    qualification: "HOT",
    confidencePct: 74,
  ...
  {
    id: "RET-REP4",
    companyName: "Patel General Store",
  ...
  {
    id: "HR-REP1",
    companyName: "TalentBridge HR Solutions",
    city: "Ghatkopar East, Mumbai",
    industry: "HR & Recruitment" as Lead["industry"],
    website: "www.talentbridgehrsoluti.in",
    employees: "2–5",
  ...
  {
    id: "ID-REP1",
    companyName: "Spaces & Aesthetics Studio",
    city: "Viman Nagar, Pune",
  ...
  {
    id: "ID-REP2",
    companyName: "Vastu Inspired Interiors",
    city: "Andheri East, Mumbai",
    industry: "Interior Design" as Lead["industry"],
    website: "www.vastuinspiredinterio.com",
    employees: "2–5",
    serviceFit: "CRM + Client Portal",
    qualification: "WARM",
    confidencePct: 83,
  ...
  {
    id: "FS-REP9",
    companyName: "Sunrise Mutual Fund Distributors",
    city: "Powai, Mumbai",
  ...
  {
    id: "EDU-REP1",
    companyName: "Bright Minds Coaching Classes",
  ...
  {
    id: "EDU-REP2",
    companyName: "Saraswati Tutorial Centre",
    city: "Balewadi, Pune",
    industry: "Education" as Lead["industry"],
    website: "",
    employees: "80–130",
  ...
  {
    id: "EDU-REP3",
    companyName: "EduPro Skill Academy",
    city: "Sadashiv Peth, Pune",
    industry: "Education" as Lead["industry"],
    website: "",
    employees: "15–40",
  ...
  {
    id: "EDU-REP4",
    companyName: "Dnyanpeeth Institute",
    city: "Vashi, Navi Mumbai",
    industry: "Education" as Lead["industry"],
    website: "",
    employees: "15–35",
  ...
  },
  {
    ...
    city: "Warje, Pune",
    industry: "Education" as Lead["industry"],
    website: "www.futureleadersacademy.com",
    employees: "50–100",
    serviceFit: "CRM + Student App",
    qualification: "WARM",
    confidencePct: 80,
  ...
  {
    id: "EDU-REP7",
    companyName: "Vidyalankar Career Classes",
    city: "Baner, Pune",
    industry: "Education" as Lead["industry"],
    website: "www.vidyalankarcareercla.in",
    employees: "100–150",
  ...
  {
    id: "EDU-REP8",
    companyName: "Prerna Learning Hub",
    city: "Aundh, Pune",
    industry: "Education" as Lead["industry"],
    website: "",
    employees: "80–120",
  ...
  {
    id: "EDU-REP9",
    companyName: "Master Minds Education",
    city: "Hadapsar, Pune",
    industry: "Education" as Lead["industry"],
    website: "",
    employees: "80–150",
  ...
  {
    id: "EDU-REP10",
    companyName: "Catalyst Coaching Institute",
    city: "Hadapsar, Pune",
    industry: "Education" as Lead["industry"],
    website: "",
    employees: "80–130",
  ...
  {
    id: "EDU-REP11",
    companyName: "Excel Spoken English Classes",
    city: "Borivali West, Mumbai",
    industry: "Education" as Lead["industry"],
    website: "www.excelspokenenglishcl.in",
    employees: "10–30",
    serviceFit: "CRM + Student App",
    qualification: "WARM",
    confidencePct: 80,
  ...
  {
    id: "EDU-REP12",
    companyName: "Global Kids Pre-School",
    city: "Thane East, Thane",
    industry: "Education" as Lead["industry"],
    website: "",
    employees: "50–100",
  ...
  {
    id: "EDU-REP13",
    companyName: "Achievers IAS Academy",
    city: "Borivali West, Mumbai",
    industry: "Education" as Lead["industry"],
    website: "",
    employees: "10–25",
  ...
  {
    id: "EDU-REP14",
    companyName: "Techno Kids Robotics Classes",
    city: "Sadashiv Peth, Pune",
    industry: "Education" as Lead["industry"],
    website: "",
    employees: "80–130",
  ...
  {
    id: "LOG-REP1",
    companyName: "Shyam Transport & Logistics",
    city: "Wakad, Pune",
    industry: "Logistics" as Lead["industry"],
    website: "",
    employees: "15–40",
  ...
  {
    id: "LOG-REP2",
    companyName: "Swiftmove Courier Services",
    city: "Magarpatta, Pune",
    industry: "Logistics" as Lead["industry"],
    website: "",
    employees: "20–50",
  ...
  {
    id: "LOG-REP3",
    companyName: "Balaji Freight Carriers",
    city: "Kurla West, Mumbai",
    industry: "Logistics" as Lead["industry"],
    website: "",
    employees: "15–35",
  ...
  {
    id: "LOG-REP4",
    companyName: "AirEx Logistics Mumbai",
    city: "Vashi, Navi Mumbai",
    industry: "Logistics" as Lead["industry"],
    website: "",
    employees: "15–40",
  ...
  {
    id: "EC-REP1",
    companyName: "Zibra Online Store",
    city: "Pimpri, Pune",
    industry: "E-Commerce",
    website: "",
    employees: "2-8",
...
Home decor brands that go D2C with a proper platform see 40% higher AOV — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EC-REP4",
    companyName: "Meera Handlooms Online",
    city: "Bandra East, Mumbai",
    industry: "E-Commerce",
    website: "",
    employees: "5-15",
...
Sports nutrition D2C brands scaling past ₹50L/month need a unified SaaS platform — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EC-REP5",
    companyName: "Gadget Galaxy India",
    city: "Airoli, Navi Mumbai",
    industry: "E-Commerce",
    website: "www.gadgetgalaxyindia.co.in",
    employees: "2-8",
    serviceFit: "CRM + WhatsApp Commerce",
    qualification: "HOT",
    confidencePct: 80,
...
Craft marketplaces on Instagram are scaling fast and need commerce automation — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EC-REP6",
    companyName: "Kiran Organic Store",
    city: "Airoli, Navi Mumbai",
    industry: "E-Commerce",
    website: "",
    employees: "2-8",
...
Healthy snack subscription brands need order automation before 500+ subs — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EC-REP7",
    companyName: "Trendy Threads Mumbai",
    city: "Goregaon West, Mumbai",
    industry: "E-Commerce",
    website: "www.trendythreadsmumbai.com",
    employees: "2-8",
    serviceFit: "CRM + App",
    qualification: "WARM",
    confidencePct: 82,
...
Herbal tea D2C brands with 200+ customers need a loyalty app to retain them — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EC-REP11",
    companyName: "NatureCraft Artisans",
    city: "Chembur, Mumbai",
    industry: "E-Commerce",
    website: "",
    employees: "3-10",
...
Premium fashion D2C brands need a platform that matches the product quality — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EC-REP13",
    companyName: "Urban Essentials Store",
    city: "Borivali West, Mumbai",
    industry: "E-Commerce",
    website: "",
    employees: "2-8",
...
Sustainable goods brands entering B2B corporate gifting need a CRM for it — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EC-REP15",
    companyName: "HomeCraft Online",
    city: "Malad West, Mumbai",
    industry: "E-Commerce",
    website: "www.homecraftonline.com",
    employees: "5-15",
    serviceFit: "SaaS + E-commerce Platform",
    qualification: "HOT",
    confidencePct: 88,
...
IT corridor properties in Hinjewadi are moving fast — slow follow-up loses deals — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FS-REP10",
    companyName: "Suraksha Micro Finance",
...
Kharghar corridor seeing high buyer interest — need a system to capitalize on it — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FS-REP11",
    companyName: "Arihant Finvest",
    city: "Parel, Mumbai",
    industry: "Real Estate",
    website: "www.arihantfinvest.in",
    employees: "3-10",
    serviceFit: "SaaS + Mobile App",
    qualification: "HOT",
    confidencePct: 88,
...
Property managers with 50+ units lose hours monthly to manual rent follow-ups — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FS-REP12",
    companyName: "Rajesh & Associates CAs",
    city: "Malad West, Mumbai",
    industry: "Real Estate",
    website: "",
    employees: "3-10",
...
Panvel corridor is booming — agents without a mobile CRM will miss the wave — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "ID-REP4",
    companyName: "Srishti Decor Solutions",
    city: "Goregaon East, Mumbai",
    industry: "Real Estate",
    website: "",
    employees: "3-10",
...
NRI real estate market in Mumbai is growing 25% YoY — digital experience is mandatory — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "ID-REP5",
    companyName: "Neha's Interior Studio",
    city: "Ghatkopar East, Mumbai",
    industry: "Healthcare",
    website: "www.nehasinteriorstudio.co.in",
    employees: "5-15",
    serviceFit: "CRM + Patient App",
    qualification: "HOT",
    confidencePct: 90,
...
CrossFit boxes that digitize the experience retain members 40% longer — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FIT-REP9",
    companyName: "Shankara Yoga Kendra",
    city: "Hadapsar, Pune",
    industry: "Fitness",
    website: "",
    employees: "2-8",
...
Dance studios managing 200+ students need a booking app to stay sane — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FIT-REP10",
    companyName: "FitPro Crossfit Pune",
    city: "Kandivali West, Mumbai",
    industry: "Fitness",
    website: "www.fitprocrossfitpune.in",
    employees: "3-10",
    serviceFit: "SaaS + Mobile App",
    qualification: "WARM",
    confidencePct: 88,
...
Online fitness coaches scaling past 100 clients need a SaaS platform to deliver it properly — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FIT-REP11",
    companyName: "Bodycraft Gymnasium",
    city: "Worli, Mumbai",
    industry: "Fitness",
    website: "",
    employees: "3-10",
...
Martial arts academies with 150+ students need an app to manage belt progression — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FIT-REP12",
    companyName: "CoreFit Training Studio",
    city: "Viman Nagar, Pune",
    industry: "Fitness",
    website: "",
    employees: "2-8",
...
Coaching classes in Mumbai that launch a student app retain 90% of students year-on-year — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EDU-REP15",
    companyName: "Gyan Sagar Tutorial",
    city: "Mulund West, Mumbai",
    industry: "Education",
    website: "",
    employees: "3-10",
...
Kids' coding schools that launch a learning app see 80% higher retention — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "ID-REP6",
    companyName: "Urban Canvas Interiors",
    city: "Magarpatta, Pune",
    industry: "Education",
    website: "",
    employees: "3-10",
...
Language institutes that build a learning app double their trial-to-enrolment rate — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "ID-REP7",
    companyName: "Orchid Design House",
    city: "Balewadi, Pune",
    industry: "Education",
    website: "",
    employees: "2-8",
...
Art studios that digitize student portfolios attract premium admissions — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "ID-REP8",
    companyName: "Kreativity Interiors Pune",
    city: "Santacruz East, Mumbai",
    industry: "Education",
    website: "",
    employees: "5-15",
...
UPSC coaching institutes that launch a SaaS platform outperform offline-only competitors by 2x — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "ID-REP9",
    companyName: "Archi-Space Design",
    city: "Belapur, Navi Mumbai",
    industry: "Education",
    website: "",
    employees: "2-8",
...
Music schools that offer a practice app have 60% better student retention — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "ID-REP10",
    companyName: "Hues & Textures Studio",
    city: "Kharadi, Pune",
    industry: "Education",
    website: "",
    employees: "3-10",
...
Craft beer taprooms that launch a loyalty app see 50% higher repeat visit frequency — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FNB-REP9",
    companyName: "The Biryani Trail Pune",
...
Meal prep businesses scaling past 150 weekly customers need an app to manage complexity — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FNB-REP10",
    companyName: "Chatpata Street Food",
    city: "Lower Parel, Mumbai",
    industry: "Food & Beverage",
    website: "",
    employees: "2-8",
...
Private dining experiences in Mumbai attract premium buyers who expect digital booking — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FNB-REP11",
    companyName: "Harvest Organic Cafe",
    city: "Malad West, Mumbai",
    industry: "Food & Beverage",
    website: "",
    employees: "2-8",
...
Wealth advisors without a client portal are losing clients to Zerodha and Groww — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FS-REP7",
    companyName: "Nidhi Financial Services",
    city: "Warje, Pune",
    industry: "Financial Services",
    website: "",
    employees: "2-8",
...
Micro VCs and family offices without an investor portal lose credibility with LPs — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "FS-REP8",
    companyName: "Param Tax Consultants",
    city: "Aundh, Pune",
    industry: "Financial Services",
    website: "www.paramtaxconsultants.in",
    employees: "2-8",
    serviceFit: "CRM + Client Portal",
    qualification: "WARM",
    confidencePct: 82,
...
Event companies managing 500+ guest lists on Excel risk embarrassing on-the-day failures — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EVT-REP4",
    companyName: "Carnival Corporate Events",
...
B2B tech conferences growing past 300 attendees need a proper event management platform — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EVT-REP5",
    companyName: "Ankur Decor & Events",
    city: "Pimpri, Pune",
    industry: "Events / Marketing",
    website: "",
    employees: "3-10",
...
Marketing agencies managing 15+ clients can't deliver consistent reporting without a CRM — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "EVT-REP6",
    companyName: "Star Entertainment Mumbai",
    city: "Vikhroli, Mumbai",
    industry: "Events / Marketing",
    website: "",
    employees: "2-8",
...
IT recruitment agencies in Hinjewadi without an ATS are leaving 40% of placements on the table — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "HR-REP2",
    companyName: "PeopleFirst Staffing",
    city: "Bandra West, Mumbai",
    industry: "HR & Recruitment",
    website: "www.peoplefirststaffing.com",
    employees: "5-15",
    serviceFit: "CRM + ATS",
    qualification: "WARM",
    confidencePct: 82,
...
Jewellery retailers building a CRM + app ahead of wedding season capture 3x more referrals — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "RET-REP5",
    companyName: "Lifestyle Home & Garden Store",
    city: "Parel, Mumbai",
    industry: "Retail",
    website: "",
    employees: "2-8",
...
Interior designers adding a client portal see 60% fewer mid-project disputes — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "ID-REP3",
    companyName: "Palette Interior Design",
    city: "Borivali East, Mumbai",
    industry: "Interior Design",
    website: "",
    employees: "3-10",
...
Interior firms working on new construction projects in Pune Baner have a 6-month window to dominate the market — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "LOG-REP5",
    companyName: "Vijay Road Carriers",
    city: "Hadapsar, Pune",
    industry: "Logistics",
    website: "",
    employees: "5-15",
...
Cold chain logistics companies face regulatory pressure to track and document temperature compliance — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "LOG-REP6",
    companyName: "Om Sai Packers & Movers",
    city: "Baner, Pune",
    industry: "Logistics",
    website: "",
    employees: "3-10",
...
Hyperlocal delivery startups scaling to 1000+ deliveries/day need a proper dispatch app — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "CON-REP1",
    companyName: "Pragati Business Consultants",
    city: "Vashi, Navi Mumbai",
    industry: "Consulting",
    website: "",
    employees: "3-10",
...
Startup advisory firms that build a client portal get featured in investor networks as a premium service — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "CON-REP2",
    companyName: "Strategic Edge Advisory",
    city: "Chinchwad, Pune",
    industry: "Consulting",
    website: "www.strategicedgeadvisor.com",
    employees: "3-10",
    serviceFit: "CRM",
    qualification: "WARM",
    confidencePct: 80,
...
Influencer marketing agencies managing 50+ creators need a CRM app or they lose brands to agencies that have one — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "LOG-REP7",
    companyName: "HorizonXpress Shipping",
    city: "Kurla West, Mumbai",
    industry: "E-Commerce",
    website: "",
    employees: "3-10",
...
Farm-to-home delivery businesses scaling past 300 daily orders need a dedicated app — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "LOG-REP8",
    companyName: "Ashirwad Cargo Services",
    city: "Malad West, Mumbai",
    industry: "E-Commerce",
    website: "",
    employees: "5-15",
...
Sports D2C brands losing 30% margin to Amazon need a full owned platform with B2B capabilities — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "LOG-REP9",
    companyName: "RapidRun Last-Mile Delivery",
    city: "Kharghar, Navi Mumbai",
    industry: "E-Commerce",
    website: "",
    employees: "3-10",
...
Corporate gifting companies without a WhatsApp commerce CRM miss 40% of Diwali season revenue — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
  ...
  {
    id: "LOG-REP10",
    companyName: "MetroCargo Solutions",
    city: "Chinchwad, Pune",
    industry: "E-Commerce",
    website: "www.metrocargosolutions.co.in",
    employees: "2-8",
    serviceFit: "CRM + App",
    qualification: "WARM",
    confidencePct: 79,
...
Herbal wellness D2C brands building loyalty apps in 2025 will dominate the repeat purchase market — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "HR-REP3",
    companyName: "Naukri Setu Consultancy",
    city: "Kurla West, Mumbai",
    industry: "HR & Recruitment",
    website: "www.naukrisetuconsultanc.in",
    employees: "3-10",
    serviceFit: "CRM + ATS",
    qualification: "WARM",
    confidencePct: 87,
...
IT recruitment agencies in Hinjewadi without an ATS are leaving 40% of placements on the table — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "HR-REP5",
    companyName: "Aspire Talent Acquisition",
    city: "Kalyani Nagar, Pune",
    industry: "HR & Recruitment",
    website: "www.aspiretalentacquisit.com",
    employees: "3-10",
    serviceFit: "CRM + ATS",
    qualification: "WARM",
    confidencePct: 87,
...
IT recruitment agencies in Hinjewadi without an ATS are leaving 40% of placements on the table — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "HR-REP6",
    companyName: "WorkForce Dynamics",
    city: "Kurla West, Mumbai",
    industry: "HR & Recruitment",
    website: "",
    employees: "3-10",
...
IT recruitment agencies in Hinjewadi without an ATS are leaving 40% of placements on the table — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "HR-REP7",
    companyName: "CareerCraft HR Services",
    city: "Deccan Gymkhana, Pune",
    industry: "HR & Recruitment",
    website: "",
    employees: "3-10",
...
IT recruitment agencies in Hinjewadi without an ATS are leaving 40% of placements on the table — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "HR-REP8",
    companyName: "Synapse Staffing Solutions",
    city: "Andheri East, Mumbai",
    industry: "HR & Recruitment",
    website: "",
    employees: "3-10",
...
IT recruitment agencies in Hinjewadi without an ATS are leaving 40% of placements on the table — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "EVT-REP7",
    companyName: "Celebration Hub Pune",
    city: "Bandra West, Mumbai",
    industry: "Events / Marketing",
    website: "",
    employees: "5-15",
...
B2B tech conferences growing past 300 attendees need a proper event management platform — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "EVT-REP8",
    companyName: "Royal Occasions Events",
    city: "Warje, Pune",
    industry: "Events / Marketing",
    website: "",
    employees: "5-15",
...
B2B tech conferences growing past 300 attendees need a proper event management platform — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP1",
    companyName: "Pixel Perfect Digital Agency",
    city: "Borivali East, Mumbai",
    industry: "Media / Marketing",
    website: "www.pixelperfectdigitala.in",
    employees: "3-10",
    serviceFit: "CRM + Client Portal",
    qualification: "WARM",
    confidencePct: 83,
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP2",
    companyName: "BrandSpark Marketing",
    city: "Dadar West, Mumbai",
    industry: "Media / Marketing",
    website: "",
    employees: "3-10",
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP3",
    companyName: "Konnect Social Media Studio",
    city: "Warje, Pune",
    industry: "Media / Marketing",
    website: "",
    employees: "3-10",
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP4",
    companyName: "Vidya Media Productions",
    city: "Viman Nagar, Pune",
    industry: "Media / Marketing",
    website: "",
    employees: "3-10",
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP5",
    companyName: "Print & Beyond Advertising",
    city: "Wakad, Pune",
    industry: "Media / Marketing",
    website: "",
    employees: "3-10",
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP6",
    companyName: "Clickwave Performance Marketing",
    city: "Malad East, Mumbai",
    industry: "Media / Marketing",
    website: "",
    employees: "3-10",
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP7",
    companyName: "Studio One Content Creation",
    city: "Goregaon West, Mumbai",
    industry: "Media / Marketing",
    website: "www.studioonecontentcrea.co.in",
    employees: "3-10",
    serviceFit: "CRM + Client Portal",
    qualification: "WARM",
    confidencePct: 83,
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP8",
    companyName: "Pratibimb Film Productions",
    city: "Nerul, Navi Mumbai",
    industry: "Media / Marketing",
    website: "",
    employees: "3-10",
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP9",
    companyName: "Inbound India Growth Agency",
    city: "Thane West, Thane",
    industry: "Media / Marketing",
    website: "",
    employees: "3-10",
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP10",
    companyName: "Ananya PR & Communications",
    city: "Deccan Gymkhana, Pune",
    industry: "Media / Marketing",
    website: "www.ananyaprcommunicatio.in",
    employees: "3-10",
    serviceFit: "CRM + Client Portal",
    qualification: "WARM",
    confidencePct: 83,
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP11",
    companyName: "DigiCraft Web Solutions",
    city: "Kondhwa, Pune",
    industry: "Media / Marketing",
    website: "",
    employees: "3-10",
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "MM-REP12",
    companyName: "Trendsetters Branding Co",
    city: "Kandivali West, Mumbai",
    industry: "Media / Marketing",
    website: "",
    employees: "3-10",
...
Content studios managing 15+ client brands need a CRM + portal to deliver consistently — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "CON-REP3",
    companyName: "Insight Partners India",
    city: "Kondhwa, Pune",
    industry: "Consulting",
    website: "",
    employees: "2-8",
...
Startup advisory firms that build a client portal get featured in investor networks as a premium service — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "CON-REP4",
    companyName: "Navneet Management Consulting",
    city: "Borivali West, Mumbai",
    industry: "Consulting",
    website: "",
    employees: "2-8",
...
Startup advisory firms that build a client portal get featured in investor networks as a premium service — that's exactly when businesses like yours see the most ROI from getting this in place. Want me to walk you through how it works in 15 minutes? No pitch, just a quick demo.`; },
    ...
    {
    id: "CON-REP5",
    companyName: "Vidhi Legal & Business Advisory",
    city: "Worli, Mumbai",
    industry: "Consulting",
    website: "",
    employees: "2-8",
