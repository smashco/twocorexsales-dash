...
export const leads: Lead[] = [
  ...
  {
    id: "MFG-26",
    companyName: "STEER World",
    city: "Bangalore",
    industry: "Manufacturing" as Lead["industry"],
    website: "https://steerlife.com",
    employees: "25-50",
    serviceFit: "Custom App" as Lead["serviceFit"],
    qualification: "HOT" as "HOT" | "WARM",
    confidencePct: 74,
    score: 8,
    category: "HIGH VALUE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "global dealer and distributor network managed without a unified CRM platform",
    painPoint2: "machine commissioning and field service scheduling tracked in isolated spreadsheets",
    painPoint3: "application development project pipeline has no structured customer tracking system",
    intentLevel: "HIGH" as "HIGH" | "MEDIUM",
  ...
  },
  {
    ...
    score: 9,
    category: "HIGH VALUE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "multi-modal freight coordination across air, sea, and surface tracked in disconnected systems",
    painPoint2: "client shipment visibility portal requires manual status updates by ops team",
    painPoint3: "revenue and volume reporting across branches consolidated manually in Excel",
    intentLevel: "HIGH" as "HIGH" | "MEDIUM",
  ...
  {
    id: "HLTH-6",
    companyName: "makeO Toothsi",
    city: "Mumbai",
    industry: "Healthcare" as Lead["industry"],
    website: "https://www.toothsi.in",
    employees: "25-50",
    serviceFit: "CRM + Portal" as Lead["serviceFit"],
    qualification: "HOT" as "HOT" | "WARM",
    confidencePct: 75,
    score: 8,
    category: "HIGH VALUE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "smile assessment consultation follow-ups managed via manual WhatsApp and calls",
    painPoint2: "clear aligner treatment progress tracked in individual patient files without automation",
    painPoint3: "multi-city clinic referral pipeline has no centralized CRM to prevent lead leakage",
    intentLevel: "HIGH" as "HIGH" | "MEDIUM",
  ...
  {
    id: "EDU-8",
    companyName: "IIM Skills",
    city: "Mumbai",
    industry: "Education" as Lead["industry"],
    website: "https://www.iimskills.com",
    employees: "25-50",
    serviceFit: "Basic CRM" as Lead["serviceFit"],
    qualification: "WARM" as "HOT" | "WARM",
    confidencePct: 63,
    score: 7,
    category: "NURTURE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "course enquiry and enrollment follow-ups managed manually via WhatsApp and email",
    painPoint2: "student progress and batch assignment tracked in Google Sheets",
    painPoint3: "alumni and placement tracking has no dedicated system",
    intentLevel: "MEDIUM" as "HIGH" | "MEDIUM",
  ...
  },
  {
    ...
    score: 9,
    category: "HIGH VALUE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "trend-based inventory planning entirely manual with no demand forecasting",
    painPoint2: "styling content-to-sale attribution missing across channels",
    painPoint3: "B2B wholesale channel managed in spreadsheets without a portal",
    intentLevel: "HIGH" as "HIGH" | "MEDIUM",
  ...
  {
    id: "CON-4",
    companyName: "Capacit'e Infraprojects",
    city: "Mumbai",
    industry: "Construction" as Lead["industry"],
    website: "https://capacite.in",
    employees: "50-100",
    serviceFit: "Custom App" as Lead["serviceFit"],
    qualification: "HOT" as "HOT" | "WARM",
    confidencePct: 76,
    score: 8,
    category: "HIGH VALUE" as "HIGH VALUE" | "NURTURE",
    painPoint1: "multi-site construction project tracking relies on daily manual reporting from site engineers",
    painPoint2: "subcontractor billing and milestone verification done through paper-based approvals",
    painPoint3: "client communication on project progress is reactive with no structured update portal",
    intentLevel: "HIGH" as "HIGH" | "MEDIUM",
